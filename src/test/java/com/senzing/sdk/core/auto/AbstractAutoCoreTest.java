...
public abstract class AbstractAutoCoreTest extends AbstractCoreTest
{
    ...
    /**
     * Protected constructor allowing the derived class to specify the location
     * for the entity respository.
     *
    ...
    /**
     * Gets the concurrency to use for this test suite. This returns
    ...
    /**
     * Gets the configuration refresh period to use for this test suite. This
